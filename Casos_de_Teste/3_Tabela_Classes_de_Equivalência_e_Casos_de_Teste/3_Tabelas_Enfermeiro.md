...
| CONDIÇÃO DE ENTRADA                        | CLASSES VÁLIDAS                                | CLASSES INVÁLIDAS                                 |
| ---------------------------------------------------- | -------------------------------------------------- | ------------------------------------------------------ |
| CPF do paciente informado corretamente               | CPF com 11 dígitos (1)                             | CPF incompleto (2)                                     |
| Número do SUS informado corretamente                 | SUS com 15 dígitos (3)                             | SUS com menos de 15 dígitos (4)                        |
